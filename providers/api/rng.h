...
#ifndef LIBSUOLA_IMPLEMENTATION_RNG_API_H
#define LIBSUOLA_IMPLEMENTATION_RNG_API_H

/* Fill a buffer with len bytes of random data.
 *
 * Returns 0 on success, non-0 otherwise.
 */
extern int suola_randombytes_buf(void * const buf, const size_t len);

#endif /* ! defined( LIBSUOLA_IMPLEMENTATION_RNG_API_H) */
