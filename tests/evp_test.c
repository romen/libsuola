...
#include <openssl/pkcs12.h>
    ...
    #define NO_DIGEST_TESTS
    #define NO_CIPHER_TESTS
    #define NO_MAC_TESTS
    #define NO_PBE_TESTS
...
#ifdef CUSTOM_OPENSSL_INIT
    #include <openssl/crypto.h>
#endif /* CUSTOM_OPENSSL_INIT */
...
#ifdef CUSTOM_OPENSSL_INIT
    /* define OPENSSL_CONF=$PWD/libsuola.cnf */
#ifndef OPENSSL_V102_COMPAT
    OPENSSL_init_crypto(
